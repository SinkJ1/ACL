...
import { AclSidComponent } from './acl-sid.component';

describe('Component Tests', () => {
  describe('AclSid Management Component', () => {
    let comp: AclSidComponent;
    let fixture: ComponentFixture<AclSidComponent>;
    let service: AclSidService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [HttpClientTestingModule],
        declarations: [AclSidComponent],
      })
        .overrideTemplate(AclSidComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(AclSidComponent);
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.aclSids[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
